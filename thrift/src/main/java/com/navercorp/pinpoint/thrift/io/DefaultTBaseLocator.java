...
class DefaultTBaseLocator implements TBaseLocator {
    ...
    private static final short SPANCHUNK_LIST = 75;
    private static final Header SPANCHUNK_LIST_HEADER = createHeader(SPANCHUNK_LIST);
    ...
    public boolean isSupport(Class<? extends TBase> clazz) {
        ...
        if (clazz.equals(TSpanChunkList.class)) {
            return true;
        }
