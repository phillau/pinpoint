...
public class TAsyncSpanChunk implements org.apache.thrift.TBase<TAsyncSpanChunk, TAsyncSpanChunk._Fields>, java.io.Serializable, Cloneable, Comparable<TAsyncSpanChunk> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TAsyncSpanChunk");
  ...
  private static final org.apache.thrift.protocol.TField ASYNC_SPAN_LIST_FIELD_DESC = new org.apache.thrift.protocol.TField("asyncSpanList", org.apache.thrift.protocol.TType.LIST, (short)11);
  private static final org.apache.thrift.protocol.TField APPLICATION_SERVICE_TYPE_FIELD_DESC = new org.apache.thrift.protocol.TField("applicationServiceType", org.apache.thrift.protocol.TType.I16, (short)12);

  private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
  static {
    schemes.put(StandardScheme.class, new TAsyncSpanChunkStandardSchemeFactory());
    schemes.put(TupleScheme.class, new TAsyncSpanChunkTupleSchemeFactory());
  }
  ...
  private List<TAsyncSpan> asyncSpanList; // required
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    ASYNC_SPAN_LIST((short)11, "asyncSpanList"),
    APPLICATION_SERVICE_TYPE((short)12, "applicationServiceType");
    ...
    public static _Fields findByThriftId(int fieldId) {
      switch(fieldId) {
        ...
        case 10: // END_POINT
          return END_POINT;
        case 11: // ASYNC_SPAN_LIST
          return ASYNC_SPAN_LIST;
        case 12: // APPLICATION_SERVICE_TYPE
  ...
  private static final int __APPLICATIONSERVICETYPE_ISSET_ID = 4;
  ...
  static {
    ...
    tmpMap.put(_Fields.END_POINT, new org.apache.thrift.meta_data.FieldMetaData("endPoint", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
    tmpMap.put(_Fields.ASYNC_SPAN_LIST, new org.apache.thrift.meta_data.FieldMetaData("asyncSpanList", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
            new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, TAsyncSpan.class))));
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TAsyncSpanChunk.class, metaDataMap);
  }

  public TAsyncSpanChunk() {
  }
    ...
    List<TAsyncSpan> asyncSpanList)
  {
    ...
    this.asyncSpanList = asyncSpanList;
  }

  /**
   * Performs a deep copy on <i>other</i>.
   */
  public TAsyncSpanChunk(TAsyncSpanChunk other) {
    ...
    if (other.isSetAsyncSpanList()) {
      List<TAsyncSpan> __this__asyncSpanList = new ArrayList<TAsyncSpan>(other.asyncSpanList.size());
      for (TAsyncSpan other_element : other.asyncSpanList) {
        __this__asyncSpanList.add(new TAsyncSpan(other_element));
      }
      this.asyncSpanList = __this__asyncSpanList;
    }
    this.applicationServiceType = other.applicationServiceType;
  }

  public TAsyncSpanChunk deepCopy() {
    return new TAsyncSpanChunk(this);
  }
  ...
  public int getAsyncSpanListSize() {
    return (this.asyncSpanList == null) ? 0 : this.asyncSpanList.size();
  }

  public java.util.Iterator<TAsyncSpan> getAsyncSpanListIterator() {
    return (this.asyncSpanList == null) ? null : this.asyncSpanList.iterator();
  }

  public void addToAsyncSpanList(TAsyncSpan elem) {
    if (this.asyncSpanList == null) {
      this.asyncSpanList = new ArrayList<TAsyncSpan>();
    }
    this.asyncSpanList.add(elem);
  }

  public List<TAsyncSpan> getAsyncSpanList() {
    return this.asyncSpanList;
  }

  public void setAsyncSpanList(List<TAsyncSpan> asyncSpanList) {
    this.asyncSpanList = asyncSpanList;
  }

  public void unsetAsyncSpanList() {
    this.asyncSpanList = null;
  }

  /** Returns true if field asyncSpanList is set (has been assigned a value) and false otherwise */
  public boolean isSetAsyncSpanList() {
    return this.asyncSpanList != null;
  }

  public void setAsyncSpanListIsSet(boolean value) {
    if (!value) {
      this.asyncSpanList = null;
    }
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case ASYNC_SPAN_LIST:
      if (value == null) {
        unsetAsyncSpanList();
      } else {
        setAsyncSpanList((List<TAsyncSpan>)value);
      }
      break;
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof TAsyncSpanChunk)
      return this.equals((TAsyncSpanChunk)that);
    return false;
  }

  public boolean equals(TAsyncSpanChunk that) {
    if (that == null)
      return false;
    ...
    boolean this_present_asyncSpanList = true && this.isSetAsyncSpanList();
    boolean that_present_asyncSpanList = true && that.isSetAsyncSpanList();
    if (this_present_asyncSpanList || that_present_asyncSpanList) {
      if (!(this_present_asyncSpanList && that_present_asyncSpanList))
        return false;
      if (!this.asyncSpanList.equals(that.asyncSpanList))
        return false;
    }
  ...
  public int hashCode() {
    ...
    boolean present_asyncSpanList = true && (isSetAsyncSpanList());
    list.add(present_asyncSpanList);
    if (present_asyncSpanList)
      list.add(asyncSpanList);
  ...
  @Override
  public int compareTo(TAsyncSpanChunk other) {
    ...
    lastComparison = Boolean.valueOf(isSetAsyncSpanList()).compareTo(other.isSetAsyncSpanList());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetAsyncSpanList()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.asyncSpanList, other.asyncSpanList);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("TAsyncSpanChunk(");
    boolean first = true;
    ...
    if (!first) sb.append(", ");
    sb.append("asyncSpanList:");
    if (this.asyncSpanList == null) {
      sb.append("null");
    } else {
      sb.append(this.asyncSpanList);
    }
    first = false;
    if (isSetApplicationServiceType()) {
      if (!first) sb.append(", ");
  ...
  private static class TAsyncSpanChunkStandardSchemeFactory implements SchemeFactory {
    public TAsyncSpanChunkStandardScheme getScheme() {
      return new TAsyncSpanChunkStandardScheme();
    }
  }

  private static class TAsyncSpanChunkStandardScheme extends StandardScheme<TAsyncSpanChunk> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TAsyncSpanChunk struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.asyncSpanList = new ArrayList<TAsyncSpan>(_list40.size);
                TAsyncSpan _elem41;
                for (int _i42 = 0; _i42 < _list40.size; ++_i42)
                {
                  _elem41 = new TAsyncSpan();
                  _elem41.read(iprot);
                  struct.asyncSpanList.add(_elem41);
                }
                iprot.readListEnd();
              }
              struct.setAsyncSpanListIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TAsyncSpanChunk struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.asyncSpanList != null) {
        oprot.writeFieldBegin(ASYNC_SPAN_LIST_FIELD_DESC);
        {
          oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, struct.asyncSpanList.size()));
          for (TAsyncSpan _iter43 : struct.asyncSpanList)
          {
            _iter43.write(oprot);
          }
          oprot.writeListEnd();
  ...
  private static class TAsyncSpanChunkTupleSchemeFactory implements SchemeFactory {
    public TAsyncSpanChunkTupleScheme getScheme() {
      return new TAsyncSpanChunkTupleScheme();
    }
  }

  private static class TAsyncSpanChunkTupleScheme extends TupleScheme<TAsyncSpanChunk> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TAsyncSpanChunk struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetAsyncSpanList()) {
        {
          oprot.writeI32(struct.asyncSpanList.size());
          for (TAsyncSpan _iter44 : struct.asyncSpanList)
          {
            _iter44.write(oprot);
          }
        }
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TAsyncSpanChunk struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(8)) {
        {
          ...
          struct.asyncSpanList = new ArrayList<TAsyncSpan>(_list45.size);
          TAsyncSpan _elem46;
          for (int _i47 = 0; _i47 < _list45.size; ++_i47)
          {
            _elem46 = new TAsyncSpan();
            _elem46.read(iprot);
            struct.asyncSpanList.add(_elem46);
          }
        }
        struct.setAsyncSpanListIsSet(true);
      }
