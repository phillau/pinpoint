...
public class AgentCommandController {
    ...
    public ModelAndView getActiveThreadDump(@RequestParam(value = "applicationName") String applicationName,
                                            ...
                                            @RequestParam(value = "includeStackTrace", required = false, defaultValue = "false") boolean includeStackTrace) throws TException {
        ...
        threadDump.setIncludeStackTrace(includeStackTrace);
        ...
        try {
            ...
            if (pinpointRouteResponse != null && pinpointRouteResponse.getRouteResult() == TRouteResult.OK) {
                ...
                } else if (result instanceof TCmdActiveThreadDumpRes) {
